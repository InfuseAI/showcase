...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--video_source",
        help="The source type of video.(stream/video)",
        type=str,
        default="video",
    )
    parser.add_argument(
        ...
        type=str,
        default="./data/video/demo_video.mp4",
    )
    parser.add_argument(
        "--rest_time", help="The time needed to rest.", type=int, default=1
    )
    parser.add_argument(
        "--folder_path",
        help="Folder path",
        type=str,
        default="./data/{}/images/".format(int(time.time())),
    )
    parser.add_argument(
        "--max_num_images", help="The maximum number of images", type=int, default=10
    )
